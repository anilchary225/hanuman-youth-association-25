  ...
  const announcements = [
    {
      id: 1,
      type: "urgent",
      title: "🌺 Ganpati Bappa Morya – See You Next Year! 🌺",
      description: "✨ Let us carry Bappa’s blessings of wisdom, health, and prosperity into the year ahead.🌺 Ganpati Bappa Morya… Agle Baras Tu Jaldi Aa! 🌺",
      date: "soon",
      time: "6:00 PM onwards",
      location: "Ganesh Mandapam, RachaBanda, BC Colony, Akanpally village",
      category: "🌸✨ Sri Ganesh Nimajjanam 2026 – Coming Soon ✨🌸",
      priority: "high",
      icon: Megaphone
    },
    {
